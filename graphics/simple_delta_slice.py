...
density = np.load(homedir + 'source/cic_fieldsT/cic_densityT.npy')
density = nd.gaussian_filter(density, sigma=2.0, mode='wrap')
delta   = density/density.mean() - 1.0

fig, ax = plt.subplots(figsize=(8, 8))
im1 = ax.imshow(delta[50], cmap='magma')#, vmin=0.0, vmax=density.max())
...
plt.savefig('delta_slice.png', dpi=300)
plt.show()