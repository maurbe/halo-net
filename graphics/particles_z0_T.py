...
loadpath    = homedir + 'source/simT/wmap5_l100n512.00100'
"""
...
np.save('coordinates_z0_T.npy', coordinates_IC)
"""

coordinates_IC = np.load('coordinates_z0_T.npy')
x = coordinates_IC[:, 0]
y = coordinates_IC[:, 1]
z = coordinates_IC[:, 2]
...
ax.set_ylabel('y')
ax.set_aspect('equal')
plt.savefig('particles_z0_T.png', dpi=250)
